...
PROTOCOL_SECPLUSV1_NO_EMULATION = "secplusv1-no-emulation"
PROTOCOL_SECPLUSV2 = "secplusv2"
PROTOCOL_DRYCONTACT = "drycontact"
SUPPORTED_PROTOCOLS = [PROTOCOL_SECPLUSV1, PROTOCOL_SECPLUSV1_NO_EMULATION, PROTOCOL_SECPLUSV2, PROTOCOL_DRYCONTACT]
...
async def to_code(config):
    ...
    if config[CONF_PROTOCOL] == PROTOCOL_SECPLUSV1_NO_EMULATION:
        cg.add_define("PROTOCOL_SECPLUSV1")
        cg.add_define("DISABLE_EMULATION")
